<template>
    ...
    <div class="max-w-2xl">
          ...
          <div class="grow">
            <div class="grid gap-2 sm:flex sm:items-center sm:justify-between">
              <div>
                ...
                >
                  <div
                    class="hs-tooltip-toggle block cursor-pointer text-left sm:mb-1"
                  >
                    <span
                    ...
                    <!-- Dropdown Card -->
                    <div
                      class="hs-tooltip-content invisible absolute z-10 inline-block max-w-xs cursor-default divide-y divide-gray-700 rounded-xl bg-gray-900 opacity-0 shadow-lg transition-opacity hs-tooltip-shown:visible hs-tooltip-shown:opacity-100 dark:bg-black"
                      role="tooltip"
                    >
                      <!-- Body -->
                      <div class="p-4 sm:p-5">
                        <div
                          class="mb-2 flex w-full gap-x-5 sm:items-center sm:gap-x-3"
                        >
                          <div class="flex-shrink-0">
                            <img
                      ...
                      >
                        ...
                        <div>
                          <button
                            type="button"
                            class="inline-flex items-center justify-center gap-x-1.5 rounded-md border border-transparent bg-blue-600 px-2.5 py-1.5 text-xs font-semibold text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
                          >
                            <svg
                              class="h-3.5 w-3.5"
                ...
                <ul class="text-xs text-gray-500">
                  <li
                    class="relative inline-block pr-6 before:absolute before:right-2 before:top-1/2 before:h-1 before:w-1 before:-translate-y-1/2 before:rounded-full before:bg-gray-300 last:pr-0 last-of-type:before:hidden dark:text-gray-400 dark:before:bg-gray-600"
                  >
                    Jan 18
                  </li>
                  <li
              ...
              <div>
                <button
                  type="button"
                  class="inline-flex items-center justify-center gap-x-1.5 rounded-md border bg-white px-2.5 py-1.5 align-middle text-xs font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white dark:border-gray-700 dark:bg-slate-900 dark:text-gray-400 dark:hover:bg-slate-800 dark:hover:text-white dark:focus:ring-offset-gray-800 sm:gap-x-2 sm:px-3 sm:py-2 sm:text-sm"
                >
                  <svg
                    class="h-3.5 w-3.5"
                    xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="space-y-5 md:space-y-8">
        ...
        <blockquote class="p-4 text-center sm:px-7">
          <p
            class="text-xl font-medium text-gray-800 dark:text-gray-200 md:text-2xl md:leading-normal xl:text-2xl xl:leading-normal"
          >
        ...
        <ul
          class="list-outside list-disc space-y-5 pl-5 text-lg text-gray-800 dark:text-gray-200"
        >
          <li class="pl-2">
        ...
        <div>
          <a
            class="m-1 inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-2 text-sm text-gray-800 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
            href="#"
          >
            Plan
          </a>
  ...
  <div class="sticky inset-x-0 bottom-6 text-center">
    <div
      class="inline-block rounded-full bg-white px-4 py-3 shadow-md dark:bg-gray-800"
    >
      <div class="flex items-center gap-x-1.5">
        ...
        <div class="hs-tooltip inline-block">
          ...
          >
            ...
            875
            <span
              class="hs-tooltip-content invisible absolute z-10 inline-block rounded-md bg-gray-900 px-2 py-1 text-xs font-medium text-white opacity-0 shadow-sm transition-opacity hs-tooltip-shown:visible hs-tooltip-shown:opacity-100 dark:bg-black"
              role="tooltip"
            >
              Like
            </span>
        ...
        <div
          class="mx-3 block h-3 border-r border-gray-300 dark:border-gray-600"
        ></div>
        ...
        <div class="hs-dropdown relative inline-flex">
          ...
          >
            <a
              class="flex items-center gap-x-3.5 rounded-md px-3 py-2 text-sm text-gray-400 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-gray-400"
              href="#"
            >
              <svg
                class="h-4 w-4"
...
export default {
  ...
  async mounted() {
    ...
    const response = await axios.get(
      `https://api.pro-phoenix.ru/api/articles?gender=${this.userGender}`
    );
